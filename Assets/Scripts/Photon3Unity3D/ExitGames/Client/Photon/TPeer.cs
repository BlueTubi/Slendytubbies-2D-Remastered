...
namespace ExitGames.Client.Photon
{
	internal class TPeer : PeerBase
	{
		...
		private sealed class _003C_003Ec__DisplayClass2
		{
			...
			public void _003CSendData_003Eb__0()
			{
		...
		internal void SendData(byte[] data)
		{
			...
			_003C_003Ec__DisplayClass.data = data;
			_003C_003Ec__DisplayClass._003C_003E4__this = this;
			try
			{
				bytesOut += _003C_003Ec__DisplayClass.data.Length;
				if (base.TrafficStatsEnabled)
				{
					TrafficStatsOutgoing.TotalPacketCount++;
				...
				if (base.NetworkSimulationSettings.IsSimulationEnabled)
				{
					if (myAction == null)
					{
						myAction = _003C_003Ec__DisplayClass._003CSendData_003Eb__0;
					}
					SendNetworkSimulated(myAction);
				}
				else
				{
					rt.Send(_003C_003Ec__DisplayClass.data, _003C_003Ec__DisplayClass.data.Length);
				}
			}
			catch (Exception ex)
			{
